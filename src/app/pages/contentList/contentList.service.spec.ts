...
// import { of } from 'rxjs';
// import { Content, ContentInterface, ContentType } from './contentList.model';
...
//       providers: [ContentService, { provide: ContentService, useValue: spy }],
//     });
...
//     const stubValue: Content = {
//       id: 'saldfkjalsdkjfoasiufao',
//       name: 'Bart de Pau',
//       tags: [
//         'native',
//         'mixed regions',
...
//       inProduction: true,
//       platforms: [
//         { name: 'Youtube', link: 'https://www.youtube.com/c/LearndutchOrg' },
//       ],
...
//     expect(contentServiceSpy.getForId.calls.count()).toEqual(
//       1,
